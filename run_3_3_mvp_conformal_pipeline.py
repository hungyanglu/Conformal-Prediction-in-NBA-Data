...
print("  (MVP Voting Share Data: 91-92 to 20-21 Seasons)")
print("="*85)
...
class ConformalEngine:
    ...
    def cqr(y_cal, cqr_lo_cal, cqr_hi_cal, cqr_lo_test, cqr_hi_test, alpha):
        ...
        lower = np.maximum(0.0, cqr_lo_test - q_val)
        upper = np.minimum(1.0, cqr_hi_test + q_val)
...
# ==============================================================================
# 4. PRINT TEST SET VALIDATION RESULTS (Section 3.3.3: 90%, 95%, 99%)
# ==============================================================================
print("\n" + "="*85)
print("  4. TEST SET VALIDATION RESULTS (SECTIONS 3.3.3: 90%, 95%, 99% COVERAGE)")
print("="*85)
